...
In this assignment, we will add two new Linux scheduler classes called **Freezer** and **Heater**. **Freezer** will be default to Linux scheduler in the end, while **Heater** does not.
...
**Heater** will have the following features and characteristics:
...
In part 4, you will code up the necessary data structures for **Heater**, flesh out
